...
[Environment]::SetEnvironmentVariable("BOOST_ROOT",$null,"User")
[Environment]::SetEnvironmentVariable("BOOST_LIBRARYDIR",$null,"User")
...
[Environment]::SetEnvironmentVariable("BOOST_ROOT", $BOOST_ROOT, "Process")
[Environment]::SetEnvironmentVariable("BOOST_LIBRARYDIR", $BOOST_LIBRARYDIR, "Process")
