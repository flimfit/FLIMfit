...
%                 %
                ...
                if ~data_series.polarisation_resolved
                    new_dataset_name = [current_dataset_name ' FLIM fitting channel ' num2str(cell2mat(obj.selected_channel)) ...
                    ' Z ' Z_str ...
                    ' C ' C_str ...
                    ' T ' T_str ' ' ...
                    datestr(now,'yyyy-mm-dd-T-HH-MM-SS')];
                else
                    new_dataset_name = [current_dataset_name ' FLIM fitting: Polarization channels ' C_str ...
                    ' Z ' Z_str ...
                    ' C ' C_str ...
                    ' T ' T_str ' ' ...
                    datestr(now,'yyyy-mm-dd-T-HH-MM-SS')];                    
                ...
                for dataset_index = 1:data_series.n_datasets
                    ...
                    new_image_description = ' ';
                     ...
                     if ~data_series.polarisation_resolved   
                        new_image_name = char(['FLIM fitting channel ' num2str(cell2mat(obj.selected_channel)) ...
                            ' Z ' Z_str ...
                            ' C ' C_str ...
                            ' T ' T_str ' ' ...
                            ' _@@_ ' ...
                        ...
                        chnls = cell2mat(obj.selected_channel);
                        chnls_str = [num2str(chnls(1)) num2str(chnls(2))];                         
                        new_image_name = char(['FLIM fitting channel ' chnls_str ...
                            ' Z ' Z_str ...
                            ' C ' C_str ...
                            ' T ' T_str ' ' ...
                            ' _@@_ ' ...
                                        ...
                                        for dataset_index = 1:data_series.n_datasets
                                            ...
                                            if (1==strcmp(imgName,imgname)) && (iid == iId) % put new well into new plate
                                                ...
                                                if isempty(newplate) % create new plate                                                    
                                                    ...
                                                    %
                                                    if ~data_series.polarisation_resolved
                                                        newplate_name = [current_plate_name ' FLIM fitting channel ' num2str(cell2mat(obj.selected_channel)) ...
                                                        ' Z ' Z_str ...
                                                        ' C ' C_str ...
                                                        ' T ' T_str ' ' ...
                                                        datestr(now,'yyyy-mm-dd-T-HH-MM-SS')];
                                                    else
                                                        newplate_name = [current_plate_name ' FLIM fitting: Polarization channels ' C_str ...
                                                        ' Z ' Z_str ...
                                                        ' C ' C_str ...
                                                        ' T ' T_str ' ' ...
                                                        datestr(now,'yyyy-mm-dd-T-HH-MM-SS')];                    
