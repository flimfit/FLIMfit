...
OutputDir={#RepositoryRoot}\GlobalProcessingStandalone\Installer
OutputBaseFilename=FLIMFit {#MyAppVersion} Setup {#MyAppArch}
SetupIconFile={#RepositoryRoot}\GlobalProcessingStandalone\Installer\microscope.ico
Compression=lzma
...
[Files]
Source: "{#RepositoryRoot}\GlobalProcessingStandalone\Installer\unzip.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
Source: "{#RepositoryRoot}\GlobalProcessingStandalone\Installer\vcredist_{#MyAppArch}.exe"; DestDir: "{tmp}"; Flags: deleteafterinstall
Source: "{#RepositoryRoot}\GlobalProcessingStandalone\GlobalProcessing_{#MyAppVersion}_{#MyAppSystem}\Start_GlobalProcessing_{#MyAppSystem}.exe"; DestDir: "{app}"; Flags: ignoreversion {#MyAppSystem}bit
Source: "{#RepositoryRoot}\GlobalProcessingStandalone\GlobalProcessing_{#MyAppVersion}_{#MyAppSystem}\FLIMGlobalAnalysis_{#MyAppSystem}.dll"; DestDir: "{app}"; Flags: ignoreversion {#MyAppSystem}bit
Source: "{#RepositoryRoot}\GlobalProcessingStandalone\GlobalProcessing_{#MyAppVersion}_{#MyAppSystem}\GlobalProcessing_{#MyAppSystem}.exe"; DestDir: "{app}"; Flags: ignoreversion {#MyAppSystem}bit

[Icons]
Name: "{group}\{#MyAppName} {#MyAppVersion}"; Filename: "{app}\Start_GlobalProcessing_{#MyAppSystem}.exe"
Name: "{commondesktop}\{#MyAppName} {#MyAppVersion}"; Filename: "{app}\Start_GlobalProcessing_{#MyAppSystem}.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\{#MyAppName} {#MyAppVersion}"; Filename: "{app}\Start_GlobalProcessing_{#MyAppSystem}.exe"; Tasks: quicklaunchicon

[Run]
Filename: "{app}\Start_GlobalProcessing_{#MyAppSystem}.exe"; Description: "{cm:LaunchProgram,{#StringChange(MyAppName, '&', '&&')}}"; Flags: nowait postinstall skipifsilent
