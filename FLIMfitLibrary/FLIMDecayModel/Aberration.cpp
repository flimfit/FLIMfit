...
void Aberration::apply(int x, int y, double_iterator a, int adim, int n_col)
{
...
int Aberration::calculateDerivatives(int x, int y, const_double_iterator a, int adim, int n_col, double_iterator b, int bdim)
{
