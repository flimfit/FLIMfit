function handles = setup_menu(window,handles)
    ...
    % OMERO MEGA MENU    
    %=================================
    menu_OMERO = uimenu(window,'Label','OMERO');
    ...
    menu_irf = uimenu(window,'Label','IRF');
    ...
    menu_background = uimenu(window,'Label','Background');
    ...
    menu_segmentation = uimenu(window,'Label','Segmentation');
    ...
    menu_tools = uimenu(window,'Label','Tools');
    ...
    menu_advanced = uimenu(window,'Label','Advanced');
    ...
    %menu_test = uimenu(window,'Label','Test');
    ...
    menu_help = uimenu(window,'Label','Help');
