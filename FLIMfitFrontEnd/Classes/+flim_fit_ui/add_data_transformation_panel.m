function handles = add_data_transformation_panel(handles,parent)
   ...
   % dataset
    ...
    handles.pol_table = uitable('Parent', pol_layout,... 
        'Data', {'0','Unpolarised'},...
        'ColumnWidth', {40, 100, 60},...
        'ColumnName', {'Ch','Polarisation','G'},...
        'ColumnFormat', {'numeric',{'Unpolarised','Parallel','Perpendicular'},'numeric'},...
