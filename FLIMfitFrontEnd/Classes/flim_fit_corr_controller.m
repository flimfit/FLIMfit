classdef flim_fit_corr_controller < abstract_plot_controller
    ...
    methods
        function obj = flim_fit_corr_controller(handles)
            ...
            set(obj.corr_source_popupmenu,'Callback',@(~,~) EC(@obj.update_display));
            set(obj.corr_display_popupmenu,'Callback',@(~,~) EC(@obj.update_display));
            set(obj.corr_scale_popupmenu,'Callback',@(~,~) EC(@obj.update_display));
