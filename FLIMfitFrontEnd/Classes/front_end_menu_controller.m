classdef front_end_menu_controller < handle
    ...
    methods
        ...
        function menu_OMERO_Load_FLIM_Data_callback(obj,~,~)
            delete(obj.data_series_controller.data_series);    % ensure delete if multiple handles
        ...
        function menu_file_load_single_callback(obj,~,~)
            % delete existing data series 
            delete(obj.data_series_controller.data_series);
