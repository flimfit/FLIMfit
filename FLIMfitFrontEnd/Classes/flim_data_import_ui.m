...
layout = uix.VBox( 'Padding', 3, 'Spacing', 3, 'Parent', fh );

l2 = uix.HBox( 'Spacing', 3, 'Padding', 3, 'Parent', layout );

uitable( 'Parent', l2 );
l3 = uix.Grid( 'Padding', 3, 'Spacing', 3, 'Parent', l2 );
...
set( l3, 'Heights', [22 22 22], 'Widths', [100, -1])
