...
% Author : Sean Warren
    ...
    if ~isdeployed
        ...
        addpath( thisdir,...
                ...
                [thisdir filesep 'HelperFunctions' filesep 'doubleops_' computer],...
                [thisdir filesep 'HelperFunctions' filesep 'doubleops_' computer filesep '@double'],...
                [thisdir filesep '..' filesep 'FLIMfitLibrary' filesep 'Libraries'],...
                [thisdir filesep '..' filesep 'FLIMreader'],...
