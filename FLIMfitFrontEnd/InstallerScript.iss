...
Source: "{#RepositoryRoot}\FLIMfitStandalone\FLIMfit_{#MyAppVersion}_{#MyAppComputer}\FLIMfit_{#MyAppSystem}.ctf”; DestDir: "{app}"; Flags: ignoreversion {#MyAppSystem}bit
