...
function ret = getOriginalFileContent(originalFile, path, session)

        % copies data from an OriginalFile (obtained from an OMERO File Annotation)
        % into a local file specified by path
