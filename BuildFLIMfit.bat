...
IF NOT DEFINED BOOST_LIBRARYDIR SET BOOST_LIBRARYDIR=%BOOST_ROOT%lib64-msvc-%MSVC_VER%.0\
...
cd FLIMfitFrontEnd
"%ProgramFiles%\MATLAB\%MATLAB_VER%\bin\matlab.exe" -nodisplay -nosplash -nodesktop -r "run('compile.m');"
